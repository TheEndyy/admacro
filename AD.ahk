...
Constructor()
{
    try {
        ...
        GameLoopTimeLimit := myGui.AddUpDown("vTimeLimit Range5-120 x218 y90 w69 h16", IniRead("config.ini", "Config", "timeLimit"))
        myGui.Add("Text", "x215 y170 w120 h16 +0x200", "Infinite mode map")
        infinitemap1 := myGui.AddDropDownList("vInfiniteMap x212 y190 w150 h100", ["Windmill Village", "Mob City", "Cursed Academy", "Blue Planet", "Underwater Temple", "Swordsman Dojo", "Snowy Woods"])
        ...
        myGui.Title := "Severed 1.0 Pre6.2"
        If (A_EventInfo == 1) {
            Return
        }
...
StartMacro(*)
{
    ...
    maps := { 1: "lib\images\windmillvillage.png", 2: "lib\images\mob_city.png", 3: "lib\images\cursed_academy.png", 4: "lib\images\blue_planet.png", 5: "lib\images\underwater_temple.png", 6: "lib\images\swordsman_dojo.png", 7: "lib\images\snowy_woods.png" }
    mapnames := ["Windmill Village", "Mob City", "Cursed Academy", "Blue Planet", "Underwater Temple", "Swordsman Dojo", "Snowy Woods"]
    ...
    myGui.Title := "Working - Severed 1.0 Pre6.2"
                    ...
                    data :=
                        (LTrim Join
                            '{
                                "content": "",
                                "embeds": [{
                                        "title": "' date '", "type": "rich", "description": "# Multi macro: Detecting game ' A_Index ' \r debug: ' abc.Text '",
                                        "image": {}, "color": 8487813
                                    }
                                ]
                            }
                ...
                Loop 2 {
                    ...
                    if DateDiff(gameEndsAt, A_Now, "Seconds") <= 0 {
                        ...
                        data2 :=
                            ...
                            "content": "",
                            "embeds": [{
                                    "title": "' date '", "type": "rich", "description": "# Multi macro: Left \r ### Time spent - ' FormatTimer(gameloopTimeLimit * 60 - DateDiff(gameEndsAt, A_Now, "Seconds")) '",
                ...
                Loop 2 {
                    ...
                    if DateDiff(gameEndsAt, A_Now, "Seconds") <= 0 {
                        ...
                        data2 :=
                            ...
                            "content": "",
                            "embeds": [{
                                    "title": "' date '", "type": "rich", "description": "# Status: Left \r ### Time spent - ' FormatTimer(gameloopTimeLimit * 60 - DateDiff(gameEndsAt, A_Now, "Seconds")) '",
                                    "image": {"url": "attachment://ss.png"}, "color": 12920612,
                                    "fields": []
                                }
                            ]
...
'
        ...
        for t in [1, 2] {
            if t = 1 and hourlybanners = 1 {
                ...
                for i in findbanner.Words {
                    if RegExMatch(i.Text, "i)Stan") and counter2 = 1 {
                        findbanner.Click(i)
                        Sleep(1000)
    ...
    ;   - Game started
    ;   - You got kicked from the portal
